...
app.get('/artikel-home.html', async (req, res) => {
    ...
    try {
        ...
        if (article) {
            // Format tanggal (misalnya, menggunakan Intl.DateTimeFormat)
            const tanggal = article.tanggalPembuatan 
                ? new Intl.DateTimeFormat('id-ID', { 
                    year: 'numeric', month: 'long', day: 'numeric' 
                  }).format(article.tanggalPembuatan.toDate())
                : '';

            // Meta tags OG yang dihasilkan di server
            const metaTags = `
                <meta property="og:title" content="${escapeHtml(article.title)}" />
                <meta property="og:description" content="${escapeHtml(article.titleKeterangan)}" />
                <meta property="og:image" content="${escapeHtml(article.photoUrl)}" />
                        ...
                        <div class="content-wrapper">
                            ...
                            <div class="wrapper">
                                ...
                                <div class="judul-halaman">
                                    <h1 id="title" class="detail-title">${escapeHtml(article.title)}</h1>
                                    <div class="title-keterangan">
                                        <p id="titleKeterangan">${escapeHtml(article.titleKeterangan)}</p>
                                        <p id="tanggalPembuatan">${escapeHtml(tanggal)}</p>
                                    </div>
                                </div>
                                <div class="container-foto">
                                    <img id="photoUrl" class="custom-foto" src="${escapeHtml(article.photoUrl)}" alt="Foto Artikel">
                                </div>
                                <p id="caption" class="keterangan-foto">${escapeHtml(article.caption || '')}</p>
                                    ...
                                    <div class="footer-content">
                                        <div class="footer-section">
                                            ...
                                            <div class="social-icons">
                                                <a href="https://facebook.com/sekawanfc" class="social-icon" target="_blank">
                                                ...
                                                <a href="https://instagram.com/sekawanfc" class="social-icon" target="_blank">
...
// Fungsi untuk menghindari XSS dengan meng-escape karakter khusus
